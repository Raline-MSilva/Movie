...
internal class MovieViewCell: UITableViewCell, SetupViewCode {
    internal static let identifier = "MovieViewCell"
    ...
    internal func setupConfigure() {
        contentView.backgroundColor = .clear
    }
    
    internal func configureCell(movie: MovieEntity) {
